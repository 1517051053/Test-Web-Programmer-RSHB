...
<body>
    ...
    <?php
            ...
            include_once "api/api_tv_season.php";
            ...
            ?>
                ...
                ?>
                <center><h1><?php echo $tv_id->original_name ?></h1></center>
                <?php
                echo "<center><h5>~ <sub>Last Air Date</sub> : <span>".$rel."</span> ~</h5></center>";
                ?>

                <hr>
                <img src="http://image.tmdb.org/t/p/w300<?php echo $tv_id->poster_path ?>" />
                <br>
                <h5>Title : <?php echo $tv_id->original_name ?><h/5>
                <h5>Status : <?php echo $tv_id->status ?></h5>
                <h5>Genre : 
                        <?php
                ...
                <h5>Ringkasan : <?php echo $tv_id->overview ?></h5>
                <h5>Tanggal Rilis : <?php $rel = date('d F Y', strtotime($tv_id->first_air_date)); echo $rel ?></h5>
                <h5>Rating : <?php echo $tv_id->vote_average ?></h5>
                
                
                <hr>

                <main class="container  p-md-2 p-2">
                <center><h4>~ Daftar Episode ~</h4></center>
